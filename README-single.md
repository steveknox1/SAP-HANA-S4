...
![SapBits Image](https://raw.githubusercontent.com/AzureCAT-GSI/SAP-HANA-S4/master/media/Structure1.png)

The following files should be present inside the SapBits folder:

![HANA Image](https://raw.githubusercontent.com/AzureCAT-GSI/SAP-HANA-S4/master/media/Structure2.png)
...
![HANA Studio Image](https://raw.githubusercontent.com/AzureCAT-GSI/SAP-HANA-S4/master/media/Structure3.png)

## Deploy the Solution
### Deploy from the Portal

To deploy from the portal using a graphic interface you can use the [![Deploy to Azure](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzureCAT-GSI%2FSAP-HANA-S4%2Fmaster%2Fazuredeploy.json) button to bring up the template in your subscription and fill out the parameters.
...
New-AzureRmResourceGroupDeployment -Name HANADeployment -ResourceGroupName HANADeploymentRG `
  -TemplateUri https://raw.githubusercontent.com/AzureCAT-GSI/SAP-HANA-S4/master/azuredeploy.json `
...
az group deployment create \
    ...
    --template-uri "https://raw.githubusercontent.com/AzureCAT-GSI/SAP-HANA-S4/master/azuredeploy.json" \
...
![Directories](https://raw.githubusercontent.com/AzureCAT-GSI/SAP-HANA-S4/master/media/directories.png)
...
![Directories2](https://raw.githubusercontent.com/AzureCAT-GSI/SAP-HANA-S4/master/media/directories2.png)

Select the option of "Build your own template in the editor"

![Directories3](https://raw.githubusercontent.com/AzureCAT-GSI/SAP-HANA-S4/master/media/directories3.png)

Copy the contents from the azuredeploy.json [file](https://raw.githubusercontent.com/AzureCAT-GSI/SAP-HANA-S4/master/azuredeploy.json) and paste them into the template editor, click Save.

![Directories4](https://raw.githubusercontent.com/AzureCAT-GSI/SAP-HANA-S4/master/media/directories4.png)
